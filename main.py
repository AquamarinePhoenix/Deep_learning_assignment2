...
from _modules.model import train, evaluate, validate, split_train_validation
...
train_data, val_data = split_train_validation(train_data, results_file)
...
model, loss_history, epoch_times = train(model, processor, optimizer, train_data, device, results_file, val_data=val_data)
...
validate(
    ...
    plot_path=cfg.OUTPUT_DIR + "training_metrics.png",
)
